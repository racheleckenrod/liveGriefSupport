...
h**t*tp://ineedchemicalx.deviantart.com/  Finding out how to deal with copy/pasting links is now in my awareness.
...
Unforunately I think I may have lost part of what I was trying to string together. and I dont know what will happen with the other file called READMETOO.md  it could be time to find out what that .md is and is for and does. so .md is markdown that gets turned into html, that could be useful, but for now, i'm glad to know
